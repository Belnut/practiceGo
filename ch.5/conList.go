...
func main() {
	...
	//we can know this part
	//1. if remove elements to use func Remove()
	//	 target is not pointed next value
	//2. e1, e2 is not clone of values, it just pointer
	//3. we can push Self List
	printList(values)
